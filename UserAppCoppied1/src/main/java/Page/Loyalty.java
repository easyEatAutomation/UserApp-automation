...
public class Loyalty extends WebBase {
	...
	private By VerifyLoyaltyOrderStatus = By.xpath("//*[@id=\"root\"]/div/div/div[3]/div[5]/div[2]/div/div[3]/div[1]/div");
	private By VerifyLoyaltyPOS = By.xpath("/html/body/app-root/body/div/div[2]/div[2]/app-order/div/div[2]/div[3]/app-order-right/div/div[2]/div[5]/div[3]/div[1]/div");

	
	
	public void LoyaltyCheckbox() throws InterruptedException {
		clickOnElement(LoyaltyCheckbox, "LoyaltyCheckbox" , 7000);
		Thread.sleep(5000);
	}
