...
//		WebElement deliveryCharge = driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div[7]/div[2]/div/div[2]/div[2]"));
...
//        Double deliveryChargeValue = Double.parseDouble(DelTextStr);
        ...
        try {
        	deliveryChargePath = driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div[7]/div[2]/div/div[2]/div[2]"));
        } catch (org.openqa.selenium.NoSuchElementException e) {
            // Element not found	
        }
		...
		String total_bill_calaculated;
		  System.out.println("SST new   " + sst);
		    ...
		    WebElement sys_bill = driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div[7]/div[2]/div/div[6]/div[2]"));
