...
public class CookingInstructions_RepeatPreviousItems extends WebBase {
	...
	private By Verify_Instructions = By.xpath("/html/body/app-root/body/div/div[2]/div[2]/app-order/div/div[2]/div[3]/app-order-right/div/div[2]/div[3]/div/div[1]/div/div[3]/span");
	private By Verify_InstructionsOrderStatus = By.xpath("//*[@id=\"root\"]/div/div/div[3]/div[4]/div[2]/div/div[2]/div[2]/div/div");
	
	
	
	public void PlusMenu() throws InterruptedException {
		clickOnElement(PlusMenu, "PlusMenu", 7000);
		Thread.sleep(2000);
	}
	...
	public void RepeatPrevious() throws InterruptedException {
		clickOnElement(RepeatPrevious, "RepeatPrevious", 7000);
		Thread.sleep(4000);
	}
	
	public void PlusCart() throws InterruptedException {
		clickOnElement(PlusCart, "PlusCart", 7000);
		Thread.sleep(2000);
	}
	
	
	public void RepeatPreviousCart() throws InterruptedException {
		clickOnElement(RepeatPreviousCart, "RepeatPreviousCart", 7000);
		Thread.sleep(2000);
	}
	...
	public void CookingInstructions() throws InterruptedException {
		clickOnElement(CookingInstructions, "CookingInstructions", 7000);
		Thread.sleep(2000);
	}
	...
	public void CookingInstructionsCheckbox() throws InterruptedException {
		clickOnElement(CookingInstructionsCheckbox, "CookingInstructionsCheckbox", 7000);
		Thread.sleep(2000);
	}
	...
	public void AddItemsforInstructions() throws InterruptedException {
		clickOnElement(AddItemsforInstructions, "AddItemsforInstructions", 7000);
		Thread.sleep(2000);
	}
	
	
	public void QuickNotes() throws InterruptedException {
		clickOnElement(QuickNotes, "QuickNotes", 7000);
		Thread.sleep(2000);
	}
	...
	public void AddInstructionsButton() throws InterruptedException {
		clickOnElement(AddInstructionsButton, "AddInstructionsButton", 7000);
		Thread.sleep(2000);
	}
	...
	public void Verify_InstructionsOrderStatus() throws InterruptedException {
		toastmessage(Verify_InstructionsOrderStatus, "Big Breakfast: Spicy , keep it spicy", 10);
		Thread.sleep(1000);
	}
