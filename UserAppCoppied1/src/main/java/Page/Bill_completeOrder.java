...
//	public static WebDriver driver;
	...
	public void Bill_validation_on_pos(String final_bill) throws InterruptedException {
		WebElement pos_bill = driver.findElement(By.xpath("/html/body/app-root/body/div/div[2]/div[2]/app-order/div/div[2]/div[3]/app-order-right/div/div[2]/div[5]/div[10]/div"));
	...
	public void Bill_validation_on_pos_for_dl_order(String final_bill) throws InterruptedException {
		WebElement pos_bill = driver.findElement(By.xpath("/html/body/app-root/body/div/div[2]/div[2]/app-order/div/div[2]/div[3]/app-order-right/div/div[2]/div[5]/div[11]/div"));
        String text = pos_bill.getText();
        String convertedText = text.replaceAll("[^0-9.]", "");
