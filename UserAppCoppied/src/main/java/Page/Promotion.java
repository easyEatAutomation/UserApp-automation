...
public class Promotion extends WebBase {
	...
	private By SetCouponCode = By.xpath("/html/body/div/div/div[1]/div[5]/div/div[1]/div[2]/div/div/input");
	//*[@id=\"root\"]/div/div[1]/div[5]/div/div[1]/div[2]/div/div
	//html/body/div/div/div[1]/div[5]/div/div[1]/div[2]/div/div/input
	...
	private By VerifyDiscountOrderStatus = By.xpath("//*[@id=\"root\"]/div/div/div[3]/div[4]/div[2]/div/div[2]/div[1]/div");
	                                                 //*[@id="root"]/div/div/div[3]/div[4]/div[2]/div/div[2]/div[1]/div
	private By VerifyDiscountPOS = By.xpath("/html/body/app-root/body/div/div/div[2]/app-order/div/div[3]/div[3]/app-order-right/div/div[2]/div[5]/div[2]/div[1]/div/p");
	                                         
	
	
	public void ApplyCoupon() throws InterruptedException {
		clickOnElement(ApplyCoupon, "ApplyCoupon", 10);
		Thread.sleep(5000);
	}
	...
	public void SelectCoupon() throws InterruptedException {
		clickOnElement(SelectCoupon, "SelectCoupon", 10);
		Thread.sleep(5000);
	}
	
	
	public void VerifyDiscount() throws InterruptedException {
		toastmessage(VerifyDiscount, "GET10", 10);
		Thread.sleep(1000);
	}
