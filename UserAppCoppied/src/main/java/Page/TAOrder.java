...
public class TAOrder extends WebBase {
	...
	private By AddButton = By
			.xpath("//*[@id=\"uniquiMenuId0\"]/div/div[2]/div[1]/div[2]/div[1]/div/div[1]/div[2]/div/div");
	...
	private By AddVariant = By.xpath(
			"//*[@id=\"uniquiMenuId0\"]/div/div[2]/div[1]/div[2]/div[1]/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[2]/div");
	...
	public void Scroll_PayCash() throws InterruptedException {
		if (scrollToElement(Pay_Cash)) {
			System.out.println("Clicked using PayCash");
		} else if (scrollToElement(IndnPay_Cash)) {
			System.out.println("Clicked using IndnPayCash");
		} else {
			System.out.println("Button not found using both IndnPayCash");
		}
	}
	...
	public String read_invoice_number() {
		WebElement invoiceElement = driver
				.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[3]/div[6]/div[1]/div[1]/div[2]"));
