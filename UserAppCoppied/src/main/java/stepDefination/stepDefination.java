...
//	public WebDriver driver;
	...
	public void i_open_browser_and(String browserName, String orderType) throws InterruptedException {
		...
		WebBase.openWebsite(orderType);
	}

	
	@Then("switch back to POS app")
	public void switch_back_to_POS_app(String url) throws InterruptedException {
		WebBase.switchToPOSApp();
		System.out.println("Switched back to POS App tab.");
	}

	@When("switch back to the User App")
	public void switch_back_to_the_User_App() {
		WebBase.switchToUserApp();
	}


	@Given("I open the home page")
	public void i_open_the_home_page() {
		WebDriverManager.chromedriver().setup(); // Automatically downloads correct driver version
...
//		stepDefination.setInvoice(Invoice);
	...
	public void user_calculate_item_total_sst_sc_pc_Discount_manually_after_adding_more_item_from_POS()
	...
	public void user_calculate_item_total_sst_sc_pc_Discount_manually_after_voiding_item_from_POS()
			throws InterruptedException {
